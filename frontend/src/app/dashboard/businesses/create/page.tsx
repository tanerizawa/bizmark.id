...
import { BusinessType, BusinessFormData } from '@/types';
...
export default function CreateBusinessPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Gagal membuat bisnis. Silakan coba lagi.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Daftarkan Bisnis Baru</h1>
              <p className="text-gray-600 mt-1">Lengkapi informasi bisnis untuk memulai proses perizinan</p>
            </div>
          </div>
        </div>

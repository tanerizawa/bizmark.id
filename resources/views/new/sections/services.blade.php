<section class="py-12 sm:py-16 lg:py-20 relative">
    <div class="absolute bottom-0 left-0 w-64 h-64 rounded-full bg-[#0D9488]/[0.02] blur-3xl pointer-events-none"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @php
            $servicesList = [
                ['title' => 'Izin Limbah B3', 'slug' => 'perizinan-lb3', 'icon' => 'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z', 'items' => ['Izin TPS LB3', 'Manifest angkut', 'Pemulihan / pembuangan'], 'featured' => true],
                ...
                ['title' => 'Izin Usaha', 'slug' => 'oss-nib', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'items' => ['Registrasi NIB', 'Setup OSS-RBA', 'SIUP · API'], 'featured' => true],
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
            ...
            <a href="/layanan/{{ $svc['slug'] }}" class="card-hover-icon {{ isset($svc['featured']) ? 'card-accent-top' : 'card-borderless' }} p-5 flex flex-col group {{ isset($svc['featured']) ? 'lg:col-span-1' : '' }}">
                ...
                <div class="flex items-center gap-1.5 text-xs font-semibold text-[#0D9488] group-hover:gap-2.5 transition-all duration-200">
                    Detail layanan
        ...
        <div class="mt-8 text-center">
            <a href="/layanan" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white rounded-xl shadow-[0_1px_4px_rgba(0,0,0,0.04)] text-sm font-semibold text-[#6B6560] hover:text-[#0D9488] hover:shadow-[0_4px_16px_rgba(0,0,0,0.06)] transition-all duration-200 hover:scale-[1.02]">

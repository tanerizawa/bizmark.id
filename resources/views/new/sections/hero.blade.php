<section class="relative overflow-hidden pt-24 pb-12 sm:pt-32 sm:pb-16 lg:pt-36 lg:pb-20">
    ...
    <div class="absolute top-20 left-1/4 w-72 h-72 rounded-full bg-[#0D9488]/5 blur-3xl animate-float-orb pointer-events-none"></div>
    <div class="absolute bottom-10 right-1/4 w-96 h-96 rounded-full bg-[#CCFBF1]/40 blur-3xl animate-float-slow pointer-events-none" style="animation-delay: -3s;"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:grid lg:grid-cols-2 lg:gap-12 xl:gap-16 items-center">
            ...
            <div class="hidden lg:block relative">
                <div class="absolute -top-10 -right-10 w-64 h-64 rounded-full bg-[#0D9488]/5 blur-3xl animate-float-slow" style="animation-delay: -2s;"></div>
                <div class="absolute -bottom-8 -left-8 w-48 h-48 rounded-full bg-[#CCFBF1] blur-3xl animate-float-orb" style="animation-delay: -5s;"></div>

                <div class="relative card-elevated animate-float-slow" style="animation-delay: -1s;">
                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-4 gap-2 mb-4">
                            <div class="text-center p-2 rounded-lg bg-[#FCFAF8]">
        ...
        <div class="mt-10 lg:mt-14">
            <div class="flex flex-wrap items-center gap-5 sm:gap-8 px-6 py-4 bg-white/60 backdrop-blur-sm rounded-xl">

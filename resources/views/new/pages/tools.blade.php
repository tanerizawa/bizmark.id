...
@section('title', 'Alat Gratis — Bizmark.ID')
@section('description', 'Alat gratis perizinan usaha dari Bizmark.ID: AI Checker, Estimasi Biaya, Polygon SHP Maker, Kalkulator Biaya Perizinan.')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mb-12">
            ...
            <h1 class="text-[clamp(1.75rem,3vw,2.5rem)] font-bold leading-[1.1] tracking-tight text-[#2D2A24] mb-3">
                Pakai platformnya sendiri. <span class="text-[#0D9488]"><em>Tanpa biaya.</em></span>
            </h1>
            <p class="text-base text-[#6B6560] leading-relaxed">Dibangun dari <strong>12+ tahun</strong> pengalaman izin nyata. Jalankan AI checker, estimasi biaya, gambar poligon — sendiri. Saat Anda butuh eksekusi lapangan, tim spesialis kami turun tangan.</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-5 sm:gap-6">
            ...
            <a href="/konsultasi-gratis" class="md:col-span-2 card-hover-icon card-elevated p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center gap-6 group">
                ...
                <div class="sm:flex-1">
                    <div class="flex items-center gap-2 mb-1">
                        <h2 class="text-lg sm:text-xl font-bold text-[#2D2A24]">Cek Kebutuhan Izin (AI)</h2>
                        <span class="inline-flex text-[11px] font-semibold px-2 py-0.5 rounded-full bg-[#0D9488] text-white">AI · Gratis</span>
                    </div>
                    <p class="text-sm text-[#6B6560] leading-relaxed">Ceritakan jenis usaha Anda, dan <strong>AI kami</strong> langsung memetakan semua izin yang perlu Anda urus — <em>tanpa biaya.</em> Cukup 30 detik.</p>
                </div>
            ...
            <a href="/estimasi-biaya" class="card-hover-icon card-borderless p-6 flex flex-col group">
                ...
                <h2 class="text-base sm:text-lg font-bold text-[#2D2A24] mb-1">Estimasi Biaya Perizinan</h2>
                <p class="text-sm text-[#6B6560] leading-relaxed mb-4 flex-1"><strong>Pilih kode KBLI</strong>, dapatkan perkiraan biaya dan estimasi durasi pengurusan izin secara langsung.</p>
            ...
            <a href="/polygon-shp-maker" class="card-hover-icon card-borderless p-6 flex flex-col group">
                ...
                <span class="inline-flex text-[10px] font-semibold tracking-wider uppercase text-[#0D9488] mb-1">Siap OSS-RBA</span>
                <h2 class="text-base sm:text-lg font-bold text-[#2D2A24] mb-1">Polygon SHP Maker</h2>
                <p class="text-sm text-[#6B6560] leading-relaxed mb-4 flex-1">Gambar poligon lokasi usaha Anda di <strong>peta interaktif</strong> dan ekspor file SHP siap pakai untuk OSS-RBA.</p>
                <div class="flex items-center gap-1.5 text-sm font-semibold text-[#0D9488] group-hover:gap-2.5 transition-all duration-200 mt-auto">
                    Buat SHP
                    <svg class="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                </div>
            ...
            <a href="/kalkulator-perizinan" class="md:col-span-2 card-hover-icon card-borderless p-6 flex flex-col sm:flex-row sm:items-center gap-4 group">
                ...
                <div class="sm:flex-1">
                    <div class="flex items-center gap-2 mb-1">
                        <h2 class="text-base sm:text-lg font-bold text-[#2D2A24]">Kalkulator Biaya Perizinan</h2>
                        <span class="inline-flex text-[10px] font-semibold px-2 py-0.5 rounded-full bg-[#CCFBF1] text-[#115E59]">50+ jenis izin</span>
                    </div>
                    <p class="text-sm text-[#6B6560] leading-relaxed">Rincian biaya lengkap berdasarkan <strong>jenis izin</strong>, dokumen yang diperlukan, dan estimasi waktu pengurusan.</p>
                </div>
                <div class="flex items-center gap-1.5 text-sm font-semibold text-[#0D9488] group-hover:gap-2.5 transition-all duration-200 flex-shrink-0">
                    Hitung Biaya
                    <svg class="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
        ...
        <div class="mt-10 text-center">
            <p class="text-sm text-[#6B6560] mb-4">Butuh bantuan eksekusi? Tim spesialis kami siap turun tangan.</p>
            <a href="/konsultasi-gratis" class="inline-flex items-center gap-2 px-6 py-3 bg-[#0D9488] text-white text-sm font-semibold rounded-xl hover:bg-[#0F766E] transition-all duration-200 shadow-sm hover:shadow-md hover:scale-[1.02]">
                Konsultasi Gratis
